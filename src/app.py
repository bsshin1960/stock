...
class StockPredictorApp:
        ...
        local_scrollbar_theme = ft.Theme(
            scrollbar_theme=ft.ScrollbarTheme(
                ...
                thumb_color={
                    ...
                    ft.ControlState.DRAGGED: hover_color,
                    ft.ControlState.PRESSED: hover_color,
    ...
    def handle_scroll_box_hover(self, e):
        ...
        # 2. Set hover flag (scroll is disabled in handle_dashboard_scroll when True)
        self.is_box_hovered = (e.data == "true")
